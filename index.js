...
function findMinMax([firstElement, ...restElements]) {
  ...
  return console.log("min: ", minNum, "max: ", maxNum);
...
function replaceNumbers(arr) {
  ...
  for (let i of arr) {
    if (i > 10) {
      arr2[arr2.length] = "Greater than 10";
    } else if (i <= 10) {
      arr2[arr2.length] = "Less than or equal to 10";
    }
  }
